...
public class Ext_angle_sides_old extends Activity {
        ...
        angle_input.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (angle_input.getText().toString().length() > 0) {
                    Toast etoast = Toast.makeText(Ext_angle_sides_old.this, "please insert a valid angle measure", Toast.LENGTH_SHORT);
                    double anglem;
                    try {
